...
React.render(
    React.createElement(Screenshots, React.__spread({},  window.PROPS)),
    document.getElementById('content')
);


},{"./views/Screenshots.jsx":177,"react":176}],2:[function(require,module,exports){
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        return (
            React.createElement("div", {id: "screenshots"}, 
                React.createElement(ImageList, {images: this.state.screenshots, onImageClick: this.showImage}), 
                React.createElement(ScreenshotModal, {hidden: !this.state.modalOpen, image: this.state.activeScreenshot.url, handleClick: this.hideImage})
            )
        );
    },
...
},{"./components/ImageList.jsx":179,"./components/ScreenshotModal.jsx":180,"react":176}],178:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "image", style: imageStyle, onClick: this.props.onImageClick.bind(null, image)})
        );
    }
});
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        var images = this.props.images.map(function(image) {
            console.log(image);
            return (
                React.createElement("li", {key: image.hash}, 
                    React.createElement(Image, {image: image, onImageClick: self.props.onImageClick})
                )
            );
        });

        return (
            React.createElement("div", {className: "image-list"}, 
                React.createElement("ul", null, 
                React.createElement(ReactCSSTransitionGroup, {transitionName: "float-in"}, 
                    images
                )
                )
            )
...
},{"./Image.jsx":178,"react/addons":4}],180:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        if (mapUrl) {
            mapDiv = (
                React.createElement("div", {className: "modal-map"}, 
                    React.createElement("iframe", {src: mapUrl})
                )
            );
        }

        return (
            React.createElement("div", {className: "modal-container", onClick: this.props.handleClick}, 
                React.createElement("div", {className: overlayClasses}), 
                React.createElement("div", {className: contentClasses}, 
                    React.createElement("div", {className: modalImageClasses, style: imageStyle}), 
                    mapDiv
                )
            )
        );
